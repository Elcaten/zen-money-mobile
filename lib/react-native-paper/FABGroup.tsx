...
import {StyleProp, StyleSheet, Animated, SafeAreaView, TouchableWithoutFeedback, View, ViewStyle} from 'react-native';
import color from 'color';
import {Card, FAB, withTheme, Text} from 'react-native-paper';
...
const FABGroup = ({
  ...
  const animations = React.useRef<Animated.Value[]>(actions.map(() => new Animated.Value(open ? 1 : 0)));
